...
g_pfnVectors:
    ...
    .word	TIM1_TRG_COM_TIM11_IRQHandler     // TIM1 Trigger and Commutation and TIM11 26
    .word	TIM1_CC_IRQHandler                // TIM1 Capture Compare 27
    .word	TIM2_IRQHandler                   // TIM2 28
    .word	TIM3_IRQHandler                   // TIM3 29
    .word	TIM4_IRQHandler                   // TIM4 30
    .word	I2C1_EV_IRQHandler                // I2C1 Event 31
    .word	I2C1_ER_IRQHandler                // I2C1 Error 32
    .word	I2C2_EV_IRQHandler                // I2C2 Event 33
    .word	I2C2_ER_IRQHandler                // I2C2 Error 34
    .word	SPI1_IRQHandler                   // SPI1 35
    .word	SPI2_IRQHandler                   // SPI2 36
    .word	USART1_IRQHandler                 // USART1 37
    .word	USART2_IRQHandler                 // USART2 38
    .word	USART3_IRQHandler                 // USART3 39
    .word	EXTI15_10_IRQHandler              // External Line[15:10] 40
